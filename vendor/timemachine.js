	...
	var OriginalDate = Date,
		Timemachine = {
			...
			_apply: function () {
				...
				Date = function () {
					...
					if (self.keepTime) {
						...
						//Cannot use OriginalDate.apply(this, arguments).  See http://stackoverflow.com/questions/181348/instantiating-a-javascript-object-by-calling-prototype-constructor-apply
			...
			_getDifference: function () {
				...
				if (this.tick) {
					difference +=
						OriginalDate.now() - this.tickStartDate.getTime();
				}
