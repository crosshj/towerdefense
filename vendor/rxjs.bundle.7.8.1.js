...
//prettier-ignore
function getRXJS(exports) { 'use strict';  
...
//NOTE: the above closure is commented and the following code added so this module can be used as ES6 in the browser

export const rxjs = {};
getRXJS(rxjs);

// core
export const animationFrameScheduler = rxjs.animationFrameScheduler;
export const of = rxjs.of;

// operators
export const takeWhile = rxjs.takeWhile;
export const filter = rxjs.filter;
export const tap = rxjs.tap;
export const repeat = rxjs.repeat;
export const finalize = rxjs.finalize;
