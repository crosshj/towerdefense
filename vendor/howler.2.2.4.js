 ...
 * Original file: /npm/howler@2.2.4/dist/howler.js
 *
	...
	(function () {
					...
					for (var t = 0; t < n._howls.length; t++)
						if (!n._howls[t]._webAudio)
							for (
								...
								var i = n._howls[t]._soundById(r[a]);
								i &&
									i._node &&
		...
		r.prototype = {
			...
			play: function (e, n) {
				...
				if (r && !u._paused) return n || t._loadQueue('play'), u._id;
					...
					if (t._webAudio) {
						var v = function () {
							...
							m.gain.setValueAtTime(e, o.ctx.currentTime),
								(u._playStart = o.ctx.currentTime),
			...
			volume: function () {
				...
				if (
					...
					return (t = n ? r._soundById(n) : r._sounds[0])
						? t._volume
						: 0;
			...
			fade: function (e, n, t, r) {
				...
				for (var i = a._getSoundIds(r), u = 0; u < i.length; u++) {
					...
					if (d) {
						...
						a._startFadeInterval(d, e, n, t, i[u], void 0 === r);
					}
				}
				return a;
			},
				...
				for (var i = 0; i < n.length; i++)
					if ((t = r._soundById(n[i]))) {
						...
						var u = r.seek(n[i]),
							d =
								(1e3 *
									((r._sprite[t._sprite][0] +
										r._sprite[t._sprite][1]) /
										1e3 -
										u)) /
								Math.abs(t._rate);
			...
			_cleanBuffer: function (e) {
				var n =
					o._navigator && o._navigator.vendor.indexOf('Apple') >= 0;
		...
		a.prototype = {
			...
			create: function () {
				var e = this,
					n = e._parent,
					t =
						o._muted || e._muted || e._parent._muted
							? 0
							: e._volume;
				return (
					n._webAudio
...
var o = t.Howl,
	r = t.Howler;
export { o as Howl, r as Howler, t as default };
//# sourceMappingURL=/vendor/howler.2.2.4.map
